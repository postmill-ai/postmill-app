...
import { DeepgramService } from '@postmill-ai/nestjs-libraries/media/deepgram/deepgram.service';
import { SaveTranscriptDto, TranscribeDto } from '@postmill-ai/nestjs-libraries/dtos/deepgram';
