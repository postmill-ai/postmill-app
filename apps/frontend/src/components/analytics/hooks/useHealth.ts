...
// One data-health row from GET /public/v1/analytics/health (6.6). Shape mirrors the
...
/**
 * Data-health / trust surface (6.6). SWR over `GET /public/v1/analytics/health`;
...
export const useHealth = () => {
  ...
  return useSWR('/public/v1/analytics/health', load, {
