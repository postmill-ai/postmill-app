...
describe('useChannelMetric', () => {
  ...
  it('builds the channel-metric SWR key from the params', () => {
    ...
    expect(mockUseSWR.mock.calls[0][0]).toBe(
      '/public/v1/analytics/channel/i1/metric/impressions?from=2026-01-01&to=2026-01-31&compare=true'
    );
  });
  ...
  it('url-encodes the integration id and metric', () => {
    ...
    expect(mockUseSWR.mock.calls[0][0]).toBe(
      '/public/v1/analytics/channel/a%2Fb/metric/a%20b?from=2026-01-01&to=2026-01-31&compare=true'
    );
  });
