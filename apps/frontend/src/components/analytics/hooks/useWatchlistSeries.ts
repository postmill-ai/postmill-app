...
// GET /public/v1/analytics/watchlist/:id/series (6.3) — the watched competitor's metric
...
export const useWatchlistSeries = (
  ...
  const key = id ? `/public/v1/analytics/watchlist/${id}/series?${params.toString()}` : null;
