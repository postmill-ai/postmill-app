...
export const ProviderFormModal: React.FC<ProviderFormModalProps> = ({
  ...
  // The clicked row fixes the type (channels pattern) — no type picker here.
  ...
  // Chromeless content: the shared modal frame supplies the title
  // (`<icon> <name> Setup|Edit`), the X, Esc, and backdrop close.
  return (
    <div className="flex flex-col gap-[16px] w-[500px] max-w-full">
