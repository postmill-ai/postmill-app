...
| AI providers / adapters | 28 providers (BYOK), facade, governance, RAG | `docs/developer-docs/ai-architecture.md`, `docs/developer-docs/adding-an-ai-adapter.md` |
...
- **AI providers: 28** (16 direct + 12 hubs/gateways), BYOK, no env fallback.
