...
| AI providers / adapters | 27 providers (BYOK), facade, governance, RAG | `docs/developer-docs/ai-architecture.md`, `docs/developer-docs/adding-an-ai-adapter.md` |
...
- **AI providers: 27** (15 direct + 12 hubs/gateways), BYOK, no env fallback.
