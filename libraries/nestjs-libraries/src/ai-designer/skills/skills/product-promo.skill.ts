...
- Split-panel layouts pair product (one side) with copy (other side); hero-fullbleed works when the product shot is atmospheric enough to carry text over a scrim.
