...
#
#   ./tools/db/postmill-migrate.sh                     # safe additive sync (refuses data loss)
#   ./tools/db/postmill-migrate.sh --accept-data-loss  # allow drops/retypes (DESTRUCTIVE — back up first!)
#
